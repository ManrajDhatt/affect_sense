...
model = keras.models.load_model('webapp/models/model_8_50epoch80_CK48dataset.h5')

try:
    face_haar_cascade = cv2.CascadeClassifier('webapp/models/haarcascade_frontalface_default.xml')
except Exception:
