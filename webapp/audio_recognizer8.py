...
scaler = load('webapp/models/std_scaler_8.bin')  # load pretrained SciKit StandardScaler
model_audio = keras.models.load_model('webapp/models/SER_model_all8_without_CREMA.h5')
